...
./graftcp/graftcp ./nvidia -a ETHASH --pool ethash.kupool.com:443 --tls on --user prodent --worker DO2 --longstats 5 --shortstats 5 --timeprint on --log on --ethstratum ETHPROXY --basecolor
